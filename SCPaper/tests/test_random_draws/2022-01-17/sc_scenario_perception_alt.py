...
class Perception:
    ...
    def update_states(self, i_time_step, ego_state, oth_state):
        ...
        self.states.x_noisy[0, i_time_step] = (self.states.x_true[0, i_time_step] 
                                               + self.noise_vector[i_time_step] 
                                               * curr_obs_noise_stddev)
    ...
    def __post_init__(self):
        ...
        if self.noisy_perception:
            ...
            # rather than drawing noise at each time step, get full noise vector now
            self.noise_vector = self.rng.normal(size=n_time_steps)
